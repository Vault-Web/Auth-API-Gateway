...
public class RefreshTokenService {
   ...
   * @return a {@link Mono} that emits the valid refresh token if it has not expired, or completes
   *     with a {@link DefaultException} error signal if the token has expired
   */
